...
# plt.show()
fig.savefig('./important_plots/growth_rate_adder_model.png')
...
# plt.show()
fig.savefig('./important_plots/av_vol_adder_model.png')
del fig
...
# plt.show()
fig.savefig('./important_plots/CV_vol_adder_model.png')
del fig
...
plt.legend()
fig.savefig('./important_plots/mother_mother_adder_model.png')
del fig
...
plt.legend()
fig.savefig('./important_plots/daughter_mother_adder_model.png')
del fig