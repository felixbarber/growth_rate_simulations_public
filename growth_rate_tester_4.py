...
plt.legend()
plt.title('Adder model: population growth rate')
# plt.show()
fig.savefig('./important_plots/growth_rate_adder_model_noiseless.png')
...
print 'population growth rate =', vals[0]
del fig
...
plt.legend()
plt.title('Adder model: Cell volume over time')
# plt.show()
fig.savefig('./important_plots/av_vol_adder_model_noiseless.png')
del fig
...
plt.ylabel('CV($V_b$)')
plt.legend()
plt.title('Adder model: CV in $V_b$ over time')
# plt.show()
fig.savefig('./important_plots/CV_vol_adder_model_noiseless.png')
del fig

vb=[]
tgrow = []
print 'r', par1['r'], 'modeltype', par1['modeltype'], 'lambda', par1['lambda']
for i0 in range(2):
...
plt.legend()
fig.savefig('./important_plots/mother_mother_adder_model_noiseless.png')
del fig
...
plt.legend()
fig.savefig('./important_plots/daughter_mother_adder_model_noiseless.png')
del fig